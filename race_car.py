...
#image code
carImg = pygame.image.load("car1.png")  # this loads the car image
...
def intro():
    ...
    while intro:
        ...
        wall_image = pygame.image.load("back1.jpg")
        gameDisplay.blit(wall_image, [0,0])
        message_display("CAR RACING", 80, display_width / 3, display_height / 3)
        ...
        message_display("Go", 50, menu1_x + menu_width / 2, menu1_y + menu_height / 2)
        message_display("Exit", 50, menu2_x + menu_width / 2, menu2_y + menu_height / 2)
...
def gameloop():
    ...
    pygame.mixer.music.play(-1) #to stop sound
